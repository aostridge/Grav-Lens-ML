...
#       model_mass_parameter_paper.keras
#       model_ellipticity_paper.keras
...
MASS_MODEL="$REPO_DIR/data/models/model_mass_parameter_paper.keras"
ELLIP_MODEL="$REPO_DIR/data/models/model_ellipticity_paper.keras"
