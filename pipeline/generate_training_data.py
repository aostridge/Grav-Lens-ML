...
from config import (
    SAVE_FILE_NAME, OVERWRITE_SOURCES, USE_PROBABILITY_SAMPLING,
    PIPELINE_DIR, SOURCES_DIR, LENSMODEL_PATH,
)
...
INPUT_FILE_PATH = FOLDER_PATH / 'lens_model.input'
DATA_FILE_PATH  = FOLDER_PATH / 'lens_model.dat'
START_FILE_PATH = FOLDER_PATH / 'lens_model.start'
GRIDMODE = 2
