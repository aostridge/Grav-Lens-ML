...
from config import FILE_NAME, OVERWRITE_TRAINING, TRAINING_MODE, SOURCES_DIR, MODELS_DIR
...
EARLY_STOPPING_PATIENCE  = 50    # matches paper §3.3: "a maximum of 50 epochs"
EARLY_STOPPING_MIN_DELTA = 1e-4  # matches paper §3.3: "improvement of less than 10^-4 per epoch"
BATCH_SIZE = 10_000
